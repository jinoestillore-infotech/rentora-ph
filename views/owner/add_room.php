<?php
/**
 * File Location: views/owner/add_room.php
 * File Name: add_room.php
 * Description: Standalone, modern, and minimalist form to specify and register a new room under an approved boarding house.
 */
...
<div class="container my-5 mt-4">
    <div class="row justify-content-center">
        <div class="col-lg-7 col-md-9 col-12">
            ...
            <!-- Page Header Title -->
            <div class="pb-3 mb-2">
                <h1 class="h2 fw-bold text-dark mb-1">Add New Room</h1>
                <p class="text-muted mb-0 small">Registering room spaces for: <strong><?php echo htmlspecialchars($house['name'] ?? '', ENT_QUOTES, 'UTF-8'); ?></strong></p>
            </div>
            ...
            <div class="card shadow-sm border rounded-3 bg-white">
                <div class="bg-transparent border-bottom border-light-subtle p-4">
                    <h5 class="card-title fw-bold text-dark mb-0">
                        <i class="fa-solid fa-door-open me-2"></i>Room Specifications
                    </h5>
                    <p class="text-muted mb-0 small">Make sure to capture actual bed capacities and list accurate amenities to assist future renters.</p>
                </div>

                <form action="<?php echo BASE_URL; ?>/owner/room/add" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" id="room_name" name="room_name" class="form-control" 
                                    placeholder="e.g. Room 101, Single Bed Fan Suite" 
                                    value="<?php echo htmlspecialchars($old['room_name'] ?? '', ENT_QUOTES, 'UTF-8'); ?>" required>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" step="0.01" id="price" name="price" class="form-control" 
                                    ...
                                    value="<?php echo htmlspecialchars($old['price'] ?? '', ENT_QUOTES, 'UTF-8'); ?>" required>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <select id="status" name="status" class="form-select">
                                    <option value="Available" <?php echo (isset($old['status']) && $old['status'] === 'Available') ? 'selected' : ''; ?>>Available</option>
                                    <option value="Fully Booked" <?php echo (isset($old['status']) && $old['status'] === 'Fully Booked') ? 'selected' : ''; ?>>Fully Booked</option>
                                    <option value="Maintenance" <?php echo (isset($old['status']) && $old['status'] === 'Maintenance') ? 'selected' : ''; ?>>Under Maintenance</option>
                                </select>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" id="capacity" name="capacity" class="form-control" 
                                    value="<?php echo htmlspecialchars($old['capacity'] ?? '1', ENT_QUOTES, 'UTF-8'); ?>" min="1" required>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" id="available_beds" name="available_beds" class="form-control" 
                                    value="<?php echo htmlspecialchars($old['available_beds'] ?? '1', ENT_QUOTES, 'UTF-8'); ?>" min="0" required>
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" id="amenities" name="amenities" class="form-control" 
                                    placeholder="e.g. Shared Toilet, WiFi, Fan, Study Desk"
                            ...
                            <div class="col-12">
                                ...
                                <span class="form-text text-muted small" style="font-size: 0.7rem;">Only JPG, JPEG, PNG, and WEBP formats are allowed (maximum size 3MB).</span>
                            </div>
                    ...
                    <div class="card-footer bg-transparent border-top border-light-subtle py-3 px-4 d-flex justify-content-end gap-2">
                        ...
                        <button type="submit" class="btn btn-dark btn-sm px-4 rounded-1">Submit Specification</button>
                    </div>
                </form>
            </div>
        </div>
